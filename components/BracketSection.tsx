...
export default function BracketSection({
  ...
  return (
    <div>
      ...
      />
      {/* Section Tabs: sticky on mobile so section switch is always available */}
      {sections.length > 1 && (
        <div className="sticky top-0 z-10 md:static mb-4 sm:mb-6 bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-100 overflow-hidden">
      ...
      {/* Section Info Banner: hidden on mobile to save space */}
      {sections.length > 1 && (
        <div className="hidden md:block bg-blue-50 border-l-4 border-blue-400 p-3 sm:p-4 mb-4 sm:mb-6 rounded-lg">
