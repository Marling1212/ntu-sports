              ...
              {displayRegularMatches.length === 0 ? (
                ...
                displayRegularMatches.map((match) => {
                  ...
                  return (
                    <div
                      key={match.id}
                      className={`block rounded-xl border border-gray-200 p-4 shadow-sm hover:border-ntu-green hover:shadow-md transition-all ${match.status === "live" ? "bg-red-50/70" : "bg-white"}`}
                    >
                      {hasGroups && (
                        <div className="mb-2">
