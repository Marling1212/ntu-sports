  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-2 px-4 py-2 bg-white text-ntu-green rounded-lg hover:bg-gray-50 transition-colors border-2 border-ntu-green shadow-md hover:shadow-lg ${className}`}
      >
        <span>📱</span>
        <span>QR Code</span>
      </button>
