            ...
            {displayMatches.map((m, idx) => {
              ...
              return (
                <tr key={m.id} className="hover:bg-gray-50">
                  ...
                  <td
                    className={`px-4 py-3 text-sm font-semibold cursor-pointer rounded ${
                      filterByPlayerId === m.player1?.id ? "ring-2 ring-ntu-green bg-ntu-green/5" : ""
                    } ${m.player1?.id ? "hover:bg-gray-50" : ""}`}
                    onClick={
                      m.player1?.id
                        ? () =>
                  ...
                  <td
                    className={`px-4 py-3 text-sm font-semibold cursor-pointer rounded ${
                      filterByPlayerId === m.player2?.id ? "ring-2 ring-ntu-green bg-ntu-green/5" : ""
                    } ${m.player2?.id ? "hover:bg-gray-50" : ""}`}
                    onClick={
                      m.player2?.id
                        ? () =>
                            setFilterByPlayerId((prev) =>
