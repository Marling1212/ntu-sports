    ...
    <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-12">
      ...
      {singleEvent && (
        <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-8 mb-4 sm:mb-8 border border-gray-100">
          <h2 className="text-lg sm:text-2xl font-semibold text-ntu-green mb-3 sm:mb-4">{t("sports.tournamentOverview")}</h2>
      ...
      {singleEvent && latestAnnouncement && (
        <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 mb-4 sm:mb-8 border border-gray-100">
          <div className="flex items-start justify-between mb-2 sm:mb-3">
            <h2 className="text-base sm:text-xl font-semibold text-ntu-green">{t("announcements.title")}</h2>
      ...
      {!hasStarted && (
        <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-8 mb-4 sm:mb-8 border border-gray-100">
          <h2 className="text-lg sm:text-2xl font-semibold text-ntu-green mb-4 sm:mb-6 text-center">
